...
namespace ITI.Gymunity.FP.Application.Services
{
        ...
        UserManager<AppUser> userManager)
    {
        ...
        public async Task<IReadOnlyList<ITI.Gymunity.FP.Application.DTOs.Trainer.SubscriberResponse>> GetSubscribersByTrainerIdAsync(int trainerProfileId)
        {
            // 1. get packages for trainer (use package repository helper)
            var pkgRepo = _unitOfWork.Repository<ITI.Gymunity.FP.Domain.Models.Trainer.Package, ITI.Gymunity.FP.Domain.RepositoiesContracts.IPackageRepository>();
